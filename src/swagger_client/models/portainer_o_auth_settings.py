...
class PortainerOAuthSettings(object):
    ...
    def __init__(self, access_token_uri=None, auth_style=None, authorization_uri=None, client_id=None, client_secret=None, default_team_id=None, kube_secret_key=None, logout_uri=None, o_auth_auto_create_users=None, redirect_uri=None, resource_uri=None, sso=None, scopes=None, user_identifier=None, _configuration=None):  # noqa: E501
    ...
    @property
    def auth_style(self):
        """Gets the auth_style of this PortainerOAuthSettings.  # noqa: E501


        :return: The auth_style of this PortainerOAuthSettings.  # noqa: E501
        :rtype: int
        """
        return self._auth_style

    @auth_style.setter
    def auth_style(self, auth_style):
        """Sets the auth_style of this PortainerOAuthSettings.


        :param auth_style: The auth_style of this PortainerOAuthSettings.  # noqa: E501
        :type: int
        """
