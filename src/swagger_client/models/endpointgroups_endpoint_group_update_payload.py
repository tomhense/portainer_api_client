...
class EndpointgroupsEndpointGroupUpdatePayload(object):
    ...
    def __init__(self, description=None, name=None, tag_ids=None, team_access_policies=None, user_access_policies=None, _configuration=None):  # noqa: E501
    ...
    @property
    def tag_ids(self):
        """Gets the tag_ids of this EndpointgroupsEndpointGroupUpdatePayload.  # noqa: E501

        List of tag identifiers associated to the environment(endpoint) group  # noqa: E501

        :return: The tag_ids of this EndpointgroupsEndpointGroupUpdatePayload.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def tag_ids(self, tag_ids):
        """Sets the tag_ids of this EndpointgroupsEndpointGroupUpdatePayload.

        List of tag identifiers associated to the environment(endpoint) group  # noqa: E501

        :param tag_ids: The tag_ids of this EndpointgroupsEndpointGroupUpdatePayload.  # noqa: E501
        :type: list[int]
        """
