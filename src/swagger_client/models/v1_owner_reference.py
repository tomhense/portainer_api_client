...
class V1OwnerReference(object):
    ...
    def __init__(self, api_version=None, block_owner_deletion=None, controller=None, kind=None, name=None, uid=None, _configuration=None):  # noqa: E501
    ...
    def controller(self):
        ...
        If true, this reference points to the managing controller. +optional  # noqa: E501
