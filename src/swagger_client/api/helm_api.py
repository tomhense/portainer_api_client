...
class HelmApi(object):
    ...
    def helm_delete(self, id, release, **kwargs):  # noqa: E501
        """Delete Helm Release  # noqa: E501

        **Access policy**: authenticated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.helm_delete(id, release, async_req=True)
        >>> result = thread.get()
        ...
        :param str namespace: An optional namespace
        :return: None
        ...
        if kwargs.get('async_req'):
            return self.helm_delete_with_http_info(id, release, **kwargs)  # noqa: E501
        else:
            (data) = self.helm_delete_with_http_info(id, release, **kwargs)  # noqa: E501
            return data

    def helm_delete_with_http_info(self, id, release, **kwargs):  # noqa: E501
        """Delete Helm Release  # noqa: E501

        **Access policy**: authenticated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.helm_delete_with_http_info(id, release, async_req=True)
        >>> result = thread.get()
    ...
    def helm_list(self, id, **kwargs):  # noqa: E501
        """List Helm Releases  # noqa: E501

        **Access policy**: authenticated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.helm_list(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: Environment(Endpoint) identifier (required)
        :param str namespace: specify an optional namespace
        :param str filter: specify an optional filter
        :param str selector: specify an optional selector
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.helm_list_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.helm_list_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def helm_list_with_http_info(self, id, **kwargs):  # noqa: E501
        """List Helm Releases  # noqa: E501

        **Access policy**: authenticated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.helm_list_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def helm_user_repositories_list(self, id, **kwargs):  # noqa: E501
        ...
        :return: UsersHelmUserRepositoryResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def helm_user_repositories_list_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='UsersHelmUserRepositoryResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def helm_user_repositories_list_deprecated(self, id, **kwargs):  # noqa: E501
        """List a users helm repositories  # noqa: E501

        Inspect a user helm repositories. **Access policy**: authenticated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.helm_user_repositories_list_deprecated(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.helm_user_repositories_list_deprecated_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.helm_user_repositories_list_deprecated_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def helm_user_repositories_list_deprecated_with_http_info(self, id, **kwargs):  # noqa: E501
        """List a users helm repositories  # noqa: E501

        Inspect a user helm repositories. **Access policy**: authenticated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.helm_user_repositories_list_deprecated_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method helm_user_repositories_list_deprecated" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `helm_user_repositories_list_deprecated`")  # noqa: E501
    ...
    def helm_user_repository_create(self, id, payload, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: User identifier (required)
        :param UsersAddHelmRepoUrlPayload payload: Helm Repository (required)
    ...
    def helm_user_repository_create_deprecated(self, id, payload, **kwargs):  # noqa: E501
        """Create a user helm repository  # noqa: E501

        Create a user helm repository. **Access policy**: authenticated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.helm_user_repository_create_deprecated(id, payload, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.helm_user_repository_create_deprecated_with_http_info(id, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.helm_user_repository_create_deprecated_with_http_info(id, payload, **kwargs)  # noqa: E501
            return data

    def helm_user_repository_create_deprecated_with_http_info(self, id, payload, **kwargs):  # noqa: E501
        """Create a user helm repository  # noqa: E501

        Create a user helm repository. **Access policy**: authenticated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.helm_user_repository_create_deprecated_with_http_info(id, payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method helm_user_repository_create_deprecated" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `helm_user_repository_create_deprecated`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if self.api_client.client_side_validation and ('payload' not in params or
                                                       params['payload'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `payload` when calling `helm_user_repository_create_deprecated`")  # noqa: E501
    ...
    def helm_user_repository_delete(self, id, repository_id, **kwargs):  # noqa: E501
        """Delete a users helm repositoryies  # noqa: E501

        **Access policy**: authenticated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.helm_user_repository_delete(id, repository_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: User identifier (required)
        :param int repository_id: Repository identifier (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.helm_user_repository_delete_with_http_info(id, repository_id, **kwargs)  # noqa: E501
        else:
            (data) = self.helm_user_repository_delete_with_http_info(id, repository_id, **kwargs)  # noqa: E501
            return data

    def helm_user_repository_delete_with_http_info(self, id, repository_id, **kwargs):  # noqa: E501
        """Delete a users helm repositoryies  # noqa: E501

        **Access policy**: authenticated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.helm_user_repository_delete_with_http_info(id, repository_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'repository_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method helm_user_repository_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `helm_user_repository_delete`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('repository_id' not in params or
            ...
            raise ValueError("Missing the required parameter `repository_id` when calling `helm_user_repository_delete`")  # noqa: E501
