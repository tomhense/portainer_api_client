...
class TeamsApi(object):
    ...
    def team_list(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param bool only_led_teams: Only list teams that the user is leader of
        :param int environment_id: Identifier of the environment(endpoint) that will be used to filter the authorized teams
    ...
    def team_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['only_led_teams', 'environment_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        query_params = []
        if 'only_led_teams' in params:
            query_params.append(('onlyLedTeams', params['only_led_teams']))  # noqa: E501
